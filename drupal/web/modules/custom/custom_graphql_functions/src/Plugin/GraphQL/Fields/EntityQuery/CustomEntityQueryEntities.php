...
namespace Drupal\custom_graphql_functions\Plugin\GraphQL\Fields\EntityQuery;
 ...
 *
 * @GraphQLField(
 *   id = "custom_entity_query_entities",
 *   secure = true,
 *   name = "entities",
 *   type = "[Entity]",
 ...
 * )
 */
class CustomEntityQueryEntities extends FieldPluginBase implements ContainerFactoryPluginInterface {
