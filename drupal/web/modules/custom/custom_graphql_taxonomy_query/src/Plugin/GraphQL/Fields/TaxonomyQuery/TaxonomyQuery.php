...
/**
 * @GraphQLField(
 *   id = "custom_taxonomy_query",
 *   secure = true,
 *   type = "[CustomTaxonomy]",
 *   name = "CustomTaxonomyQuery",
 *   arguments = {
 *     "filter" = "CustomTaxonomyFilterInput",
 *   }
 * )
 */
class TaxonomyQuery extends FieldPluginBase implements ContainerFactoryPluginInterface {
  use DependencySerializationTrait;
    ...
    $config = \Drupal::config('elasticsearch_connector.cluster.elasticsearch_cluster');
    $elasticsearch_path = $config->get('url');
    $elasticsearch_user = $config->get('options')['username'];
    $elasticsearch_pass = $config->get('options')['password'];
