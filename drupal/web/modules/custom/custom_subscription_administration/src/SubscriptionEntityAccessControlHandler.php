 ...
 *
 * @see \Drupal\custom_subscription_administration\Entity\SubscriptionEntity.
 */
class SubscriptionEntityAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\custom_subscription_administration\Entity\SubscriptionEntityInterface $entity */
    switch ($operation) {
      case 'view':
