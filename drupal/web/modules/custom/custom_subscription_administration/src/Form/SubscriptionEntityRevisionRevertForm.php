...
/**
 * Provides a form for reverting a Subscription entity revision.
 *
 * @ingroup custom_subscription_administration
 */
class SubscriptionEntityRevisionRevertForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new SubscriptionEntityRevisionRevertForm.
   *
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('entity.manager')->getStorage('subscription_entity'),
  ...
  public function getFormId() {
    return 'subscription_entity_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Subscription entity: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    drupal_set_message(t('Subscription entity %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\custom_subscription_administration\Entity\SubscriptionEntityInterface $revision
   ...
   */
  protected function prepareRevertedRevision(SubscriptionEntityInterface $revision, FormStateInterface $form_state) {
