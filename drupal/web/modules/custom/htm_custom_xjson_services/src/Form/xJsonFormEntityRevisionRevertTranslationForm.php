 ...
 */
class xJsonFormEntityRevisionRevertTranslationForm extends xJsonFormEntityRevisionRevertForm {
  ...
  public function getFormId() {
    return 'x_json_form_entity_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $x_json_form_entity_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $x_json_form_entity_revision);
  ...
  protected function prepareRevertedRevision(xJsonFormEntityInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\htm_custom_xjson_services\Entity\xJsonFormEntityInterface $default_revision */
    $latest_revision = $this->xJsonFormEntityStorage->load($revision->id());
