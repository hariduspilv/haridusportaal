 ...
 */
interface OskaEntityInterface extends ContentEntityInterface, EntityChangedInterface, EntityOwnerInterface {
   ...
   *
   * @return \Drupal\htm_custom_oska\Entity\OskaEntityInterface
