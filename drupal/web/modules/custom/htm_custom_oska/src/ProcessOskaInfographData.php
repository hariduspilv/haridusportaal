...
/**
 * Class ProcessOskaInfographData
...
class ProcessOskaInfographData {
  ...
  public static function CreateOskaGraphFilters($filename, $items, &$context){
  ...
  public static function ProcessOskaInfographDataFinishedCallback($success, $results, $operations){
