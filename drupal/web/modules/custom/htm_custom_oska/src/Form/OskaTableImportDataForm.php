 ...
 */
class OskaTableImportDataForm extends FormBase {
    ...
    public function validateForm(array &$form, FormStateInterface $form_state){
        $required_headers = [
            'valdkond', 'juurprobleem', 'ettepanek', 'peavastutaja', 'staatus', 'kommentaar'
        ];
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        $batch = [
            ...
            'operations' => [
                [
                    '\Drupal\htm_custom_oska\ProcessOskaTableData::ValidateFile',
                    [$file_array]
                ],
                [
                    '\Drupal\htm_custom_oska\ProcessOskaTableData::ProcessOskaTableData',
                    [$file_array]
                ]
            ],
            'error_message' => t('The migration process has encountered an error.'),
            'finished' => '\Drupal\htm_custom_oska\ProcessOskaTableData::ProcessOskaTableDataFinishedCallback'
        ];
