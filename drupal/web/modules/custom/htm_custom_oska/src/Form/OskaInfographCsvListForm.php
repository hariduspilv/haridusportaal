...
class OskaInfographCsvListForm extends FormBase {
  ...
  public function getFormId() {
    return 'oska_infograph_csv_list';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    ...
    foreach($csv_list as $key => $csv_name){
      ...
      $form['table'][$key]['delete'] = [
        '#type' => 'link',
        '#title' => $this->t('Delete'),
        '#url' => Url::fromRoute('htm_custom_oska.oska_delete_infograph', ['filename' => $csv_name]),
      ];
    }
