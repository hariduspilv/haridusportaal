 ...
 */
class OskaImportStudiesForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $batch = [
      'title' => t('Processing Oska Studies data ....--'),
      'operations' => [
        [
          '\Drupal\htm_custom_oska\ProcessOskaStudiesData::ValidateFile',
          [$file_array]
        ],
        [
          '\Drupal\htm_custom_oska\ProcessOskaStudiesData::ProcessOskaStudiesData',
          [$file_array]
        ],
        [
          '\Drupal\htm_custom_oska\ProcessOskaStudiesData::CleanUntouchedNodes',
          [$file_array]
        ],
      ],
      'error_message' => t('The migration process has encountered an error.'),
      'finished' => '\Drupal\htm_custom_oska\ProcessOskaStudiesData::ProcessOskaStudiesDataFinishedCallback'
    ];
