...
/**
 * Provides a resource to get enabled authentication methods.
 *
 * @RestResource(
 *   id = "auth_methods_rest_resource",
 *   label = @Translation("Authentication methods rest resource"),
 *   uri_paths = {
 *     "canonical" = "auth_methods"
 *   }
 * )
 */
class AuthMethodsRestResource extends ResourceBase {
