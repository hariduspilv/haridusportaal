...
@Component({
	...
	styleUrls: ['../list-view/schoolListView.styles.scss'],
})
	...
	checkLanguageDisable(): void {
		if (this.selectedPrimaryTypes.length === 1) {
			this.isLanguageDisabled =
				this.selectedPrimaryTypes.includes('3441') ||
				this.selectedPrimaryTypes.includes('3440')
					? true
					: false;
			return;
		}
