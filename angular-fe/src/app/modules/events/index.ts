...
import { EventsViewComponent } from './containers/eventsView/eventsView.component';
...
import { EventsListComponent } from './containers/eventsList/eventsList.component';
...
@NgModule({
	declarations: [EventsViewComponent, EventsListComponent],
	imports: [
	...
	exports: [EventsViewComponent, EventsListComponent],
	providers: [
