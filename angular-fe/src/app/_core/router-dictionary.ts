...
export const routerDictionary = [
	...
	['ettepanekute-elluviimine', 'ettepanekute-elluviimine'], 								// delivering-on-promises , 'realizacija-predlozenij'
	['gdpr', 'gdpr'],																													// , 'gdpr'
	...
	['oska-tulemused', 'oska-tulemused'],																			// oska-results , 'oska-rezultaty'
