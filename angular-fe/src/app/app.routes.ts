...
const routes: Routes = [
	...
	},
	{
		...
		loadChildren: () =>
			import(
				'./modules/certificates/containers/certificates-container/certificates-container.module'
	...
	},
	{
		...
		loadChildren: () =>
			import(
				'./modules/certificates/containers/certificates-detail/certificates-detail.module'
	...
	},
	{
		path: 'oska',
		loadChildren: () =>
			import('./_views/oskaFrontpageView').then(
				(m) => m.OskaFrontpageViewModule
			),
	},
	{
		path: 'töölaud',
	...
	},
	{
		path: 'search',
		loadChildren: () =>
			import('./modules/home-search/home-search.module').then(
				(module) => module.HomeSearchModule
			),
	},
	{
		path: 'sündmused',
	...
	},
	{
		path: 'erialad',
		loadChildren: () =>
			import('./_views/studyProgrammeListView').then(
				(m) => m.StudyProgrammeListViewModule
			),
	},
	{
	...
	},
	{
		...
		loadChildren: () =>
			import('./modules/youth-monitoring/youth-monitoring.module').then(
				(module) => module.YouthMonitoringModule
			),
	},
	{
		path: 'preview',
