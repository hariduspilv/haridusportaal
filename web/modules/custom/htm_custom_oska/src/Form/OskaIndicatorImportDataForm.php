 ...
 */
class OskaIndicatorImportDataForm extends FormBase {
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        $batch = [
            'title' => t('Processing Oska Indicator data ....--'),
            'operations' => [
                [
                    '\Drupal\htm_custom_oska\ProcessOskaIndicatorData::ValidateFile',
                    [$file_array]
                ],
                [
            ...
            'finished' => '\Drupal\htm_custom_oska\ProcessOskaIndicatorData::ProcessOskaIndicatorDataFinishedCallback'
        ];
