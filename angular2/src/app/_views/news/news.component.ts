...
export class NewsComponent implements OnInit, OnDestroy{
  ...
  // TAGS
  public newsTagObs: Observable<any[]>; // ng-select autocompletion observable

  public newsTags: any[]; //taxonomy query list
  public newsTags2: any[]; //taxonomy query list
  public selectedTags: any[]; // ng-select selected
  ...
  public showTagsInput: boolean = false;
